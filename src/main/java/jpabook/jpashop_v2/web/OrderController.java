...
import jpabook.jpashop_v2.service.OrderService;
...
public class OrderController {
    ...
    public String order(
        ...
        orderService.order(memberId, itemId, count); //영속상태 유지 위해 내부로 넘겨 서비스에서 처리하자
    ...
    public String orderList(
        ...
        //ModelAttribute -> model.addAttribute("orderSearch",orderSearch) 와 동일한 효과
